...
public class EmpyreanCrucibleInstance extends CrucibleInstance {
	...
	public void onDie(Npc npc) {
		...
		switch (npc.getNpcId()) {
			...
			case 217484, 217493 -> {
				...
				sp(217756, 342.65106f, 357.4013f, 96.09094f, (byte) 0); // S1_ResurBox1Dark_55_n
				sp(217756, 349.07376f, 357.5898f, 96.090965f, (byte) 0); // S1_ResurBox1Dark_55_n
				sp(217756, 345.69272f, 359.40958f, 96.09094f, (byte) 0); // S1_ResurBox1Dark_55_n
				sp(217756, 342.59192f, 353.73386f, 96.090965f, (byte) 0); // S1_ResurBox1Dark_55_n
				sp(217756, 342.6043f, 360.8932f, 96.09093f, (byte) 0); // S1_ResurBox1Dark_55_n
			...
			case 217500, 217509 -> {
				...
				sp(217505, 341.95056f, 334.77692f, 96.09093f, (byte) 0, 6000); // S2_LycanShaman_55_Ae
				sp(217508, 344.17813f, 334.42462f, 96.090935f, (byte) 0, 6000); // S2_LycanFighter_55_Ae
			}
			case 217505 -> {
				npc.getController().delete();
			...
			case 217510, 217501 -> {
				...
				ThreadPoolManager.getInstance().schedule(() -> {
					sp(217737, 334.49496f, 349.2322f, 96.090935f, (byte) 0); // S2_SAAM1_55_n
						...
						if (getNpc(217737) != null) {
							...
							ThreadPoolManager.getInstance().schedule(() -> {
								if (getNpc(217737) != null) {
									...
									sp(799569, 345.25f, 349.24f, 96.09097f, (byte) 0); // IDArena_3rd_MC_Start
								}
							}, 30000);
						}
					}, 30000);
			...
			case 217511, 217512, 217513, 217514 -> {
				...
				if (instance.getNpcs(217511, 217512, 217513, 217514).allMatch(id -> getNpcs(id).isEmpty())) {
					...
					sp(217517, 354.132f, 337.14255f, 96.09089f, (byte) 0, 6000); // S3_ElementalWater_2nd_55_Ae
					sp(217518, 352.77557f, 360.97845f, 96.09091f, (byte) 0, 6000); // S3_ElementalAir_2nd_55_Ae
					sp(217515, 349.16327f, 335.63864f, 96.09095f, (byte) 0, 6000); // S3_ElementalEarth_2nd_55_Ae
					sp(217516, 350.0108f, 342.09482f, 96.090935f, (byte) 0, 6000); // S3_ElementalFire_2nd_55_Ae
					sp(217517, 353.7888f, 354.4324f, 96.091064f, (byte) 0, 6000); // S3_ElementalWater_2nd_55_Ae
					sp(217518, 340.2231f, 351.10208f, 96.09098f, (byte) 0, 6000); // S3_ElementalAir_2nd_55_Ae
					sp(217515, 348.87338f, 354.90146f, 96.09096f, (byte) 0, 6000); // S3_ElementalEarth_2nd_55_Ae
					sp(217516, 334.60898f, 352.01447f, 96.09095f, (byte) 0, 6000); // S3_ElementalFire_2nd_55_Ae
					sp(217517, 341.23633f, 344.55603f, 96.09096f, (byte) 0, 6000); // S3_ElementalWater_2nd_55_Ae
					sp(217518, 354.66513f, 343.31537f, 96.091095f, (byte) 0, 6000); // S3_ElementalAir_2nd_55_Ae
				}
			}
			case 217515, 217516, 217517, 217518 -> {
				...
				if (instance.getNpcs(217515, 217516, 217517, 217518).isEmpty()) {
					...
					sp(217522, 342.1805f, 360.534f, 96.09092f, (byte) 0, 6000); // S3_ElementalAir_3rd_55_Ae
					sp(217520, 334.2686f, 342.60797f, 96.09091f, (byte) 0, 6000); // S3_ElementalFire_3rd_55_Ae
					sp(217522, 350.34537f, 356.18558f, 96.09094f, (byte) 0, 6000); // S3_ElementalAir_3rd_55_Ae
					sp(217520, 343.7485f, 336.2869f, 96.09092f, (byte) 0, 6000); // S3_ElementalFire_3rd_55_Ae
				}
			}
			case 217519, 217520, 217521, 217522 -> {
				...
				if (instance.getNpcs(217519, 217520, 217521, 217522).isEmpty()) {
					...
					sp(217526, 349.31473f, 358.43762f, 96.09096f, (byte) 0, 6000); // S3_ElementalAir_4th_55_Ae
					sp(217523, 338.73138f, 342.35876f, 96.09094f, (byte) 0, 6000); // S3_ElementalEarth_4th_55_Ae
				}
			}
				...
				switch (stageType) {
					case START_STAGE_4_ROUND_1 -> {
						if (getNpcs(217558).isEmpty()) {
							...
							sp(217559, 330.53665f, 349.23523f, 96.09093f, (byte) 0, 6000); // S5_Lizard_Pr_55_Ae
							sp(217562, 334.89508f, 363.78442f, 96.090904f, (byte) 105, 6000); // S5_Naga_Wi_55_Ae
							sp(217560, 334.61942f, 334.80353f, 96.090904f, (byte) 15, 6000); // S5_Naga_Fi_55_Ae
							ThreadPoolManager.getInstance().schedule(() -> {
								List<Npc> round = new ArrayList<>();
								round.add(sp(217557, 357.24625f, 338.30093f, 96.09104f, (byte) 65)); // S5_Lizard_Fi_55_Ae
								round.add(sp(217558, 357.20663f, 359.28714f, 96.091064f, (byte) 75)); // S5_Lizard_As_55_Ae
								round.add(sp(217561, 365.109f, 349.1218f, 96.09114f, (byte) 60)); // S5_Naga_Ch_55_Ae
			...
			case 217563, 217566 -> {
				...
				if (es != null && !es.containsNpcs()) {
					...
					sp(217567, 345.73895f, 349.49786f, 96.09097f, (byte) 0, 6000); // S5_Drakan_Fi_Boss_55_Ah
				}
			}
			...
			case 217567 -> {
				...
				sp(217653, 327.76917f, 349.26215f, 96.09092f, (byte) 0, 6000); // S5_Drop_Drakan_Wi_55_Ae
				sp(217651, 364.8972f, 349.25653f, 96.09114f, (byte) 60, 18000); // S5_Drop_Drakan_Fi_55_Ae
				sp(217652, 361.1795f, 339.99252f, 96.09112f, (byte) 50, 35000); // S5_Drop_Drakan_As_55_Ae
				sp(217653, 354.4119f, 333.6749f, 96.09091f, (byte) 40, 54000); // S5_Drop_Drakan_Wi_55_Ae
				sp(217651, 331.61502f, 358.4374f, 96.09091f, (byte) 110, 69000); // S5_Drop_Drakan_Fi_55_Ae
				sp(217652, 338.38858f, 364.91507f, 96.090904f, (byte) 100, 83000); // S5_Drop_Drakan_As_55_Ae
				sp(217651, 346.39847f, 368.19427f, 96.090904f, (byte) 90, 99000); // S5_Drop_Drakan_Fi_55_Ae
				sp(217652, 353.92606f, 364.92636f, 96.090904f, (byte) 80, 110000); // S5_Drop_Drakan_As_55_Ae
				sp(217653, 361.13452f, 358.90424f, 96.091156f, (byte) 65, 130000); // S5_Drop_Drakan_Wi_55_Ae
				sp(217652, 346.34402f, 329.9449f, 96.09091f, (byte) 30, 142000); // S5_Drop_Drakan_As_55_Ae
				ThreadPoolManager.getInstance().schedule(() -> {
					sp(217653, 331.53894f, 339.8832f, 96.09091f, (byte) 10); // S5_Drop_Drakan_Wi_55_Ae
					isDoneStage4 = true;
				}, 174000);
			}
			...
			case 217552 -> {
				...
				sp(700527, 1253.3123f, 789.38385f, 358.60562f, (byte) 119); // IDshulackship_Lever_A
				sp(700528, 1260.2015f, 800.14886f, 358.6056f, (byte) 16); // IDshulackship_Lever_B
				sp(217553, 1259.4706f, 812.30505f, 358.6056f, (byte) 30, 6000); // S4_ManduriGiantNmd_55_Ah
			}
			case 217553 -> {
				npc.getController().delete();
				deleteAliveNpcs(700527, 700528);
				sp(281111, 1246.4855f, 796.90735f, 358.6056f, (byte) 0); // BIDShulack_EngineerNozzleD_45_An
				sp(281110, 1259.5508f, 784.5548f, 358.60562f, (byte) 0); // BIDShulack_EngineerNozzleC_45_An
				sp(281112, 1276.6561f, 812.5499f, 358.60565f, (byte) 0); // BIDShulack_EngineerNozzleE_45_An
				sp(281322, 1243.2113f, 813.0927f, 358.60565f, (byte) 0); // BIDShulack_EngineerNozzleH_45_An
				sp(281109, 1272.9266f, 797.1055f, 358.60562f, (byte) 0); // BIDShulack_EngineerNozzleB_45_An
				sp(281113, 1275.894f, 780.51544f, 358.60565f, (byte) 0); // BIDShulack_EngineerNozzleF_45_An
				sp(281108, 1260.003f, 810.555f, 358.6056f, (byte) 0); // BIDShulack_EngineerNozzleA_45_An
				sp(281114, 1244.3293f, 780.4284f, 358.60562f, (byte) 0); // BIDShulack_EngineerNozzleG_45_An
				setStage(StageType.START_STAGE_5_ROUND_4, 2000);
				sp(217554, 1243.1877f, 796.79553f, 358.6056f, (byte) 0, 6000); // S4_ShulackEngineerNmd_55_Ah
			}
			case 217554 -> {
				npc.getController().delete();
				deleteAliveNpcs(281108, 281109, 281110, 281111, 281112, 281113, 281114, 281322);
				setStage(StageType.START_STAGE_5_ROUND_5, 2000);
				sp(217556, 1259.8387f, 785.6266f, 358.60562f, (byte) 30, 6000); // S4_ShulackCaptainNmd_55_Ah
				sp(281191, 1261.8f, 804.5f, 358.7f, (byte) 0, 6000); // BIDShulack_CaptainStigmaStoneA_45_n
				sp(281192, 1267.6f, 793.9f, 358.7f, (byte) 0, 6000); // BIDShulack_CaptainStigmaStoneB_45_n
				sp(281193, 1257.4f, 787.9f, 358.7f, (byte) 0, 6000); // BIDShulack_CaptainStigmaStoneC_45_n
				sp(281194, 1251.3f, 798.6f, 358.7f, (byte) 0, 6000); // BIDShulack_CaptainStigmaStoneD_45_n
			}
			case 217556 -> {
				npc.getController().delete();
				deleteAliveNpcs(281191, 281192, 281193, 281194);
				setStage(StageType.PASS_GROUP_STAGE_5, 0);
				sp(205339, 1260.1465f, 795.07495f, 358.60562f, (byte) 30); // IDArena_5th_MC_End
			}
			case 217568 -> {
				...
				if (isDoneStage6Round1 && getNpcs(217568).isEmpty()) {
					...
					sp(217569, 1639.7843f, 142.09268f, 126f, (byte) 40, 6000); // S6_LichEquip_55_Ae
					ThreadPoolManager.getInstance().schedule(() -> {
						sp(217569, 1614.6377f, 164.04999f, 126.00113f, (byte) 3); // S6_LichEquip_55_Ae
						sp(217569, 1625.8965f, 135.62509f, 126f, (byte) 30); // S6_LichEquip_55_Ae
			...
			case 217570 -> {
				for (int i = 0; i < 5; i++)
					sp(211984, npc.getX() + Rnd.get(-2, 2), npc.getY() + Rnd.get(-2, 2), npc.getZ(), npc.getHeading()); // Clodworm_41_An
			}
			case 217569 -> {
			...
			case 217572 -> {
				...
				sp(217573, 1634.7891f, 141.99077f, 126f, (byte) 0); // S6_Deathknight_Ghost_55_Ah_01
			}
			case 217573 -> {
				npc.getController().delete();
			...
			case 217586, 217587 -> {
				...
				sp(217753, 1782.881f, 800.114f, 469.420f, (byte) 0, 2000); // S7_BookBox_55_n
				sendMsg(SM_SYSTEM_MESSAGE.STR_MSG_S7_BookBox_01());
				sp(205341, 1781.610f, 796.920f, 469.350f, (byte) 0, 2000); // IDArena_7th_MC_End
			}
			case 217588, 217589 -> {
				setStage(StageType.START_STAGE_8_ROUND_2, 2000);
				sp(217590, 1764.377f, 1761.510f, 303.695f, (byte) 0, 6000); // S8_Seiren_Queen_55_Ah
			}
			case 217590 -> {
				setStage(StageType.START_STAGE_8_ROUND_3, 2000);
				sp(217591, 1776.946f, 1749.255f, 303.696f, (byte) 30, 6000); // S8_AkanNamed_50_Ah
			}
			case 217591 -> {
				setStage(StageType.START_STAGE_8_ROUND_4, 2000);
				sp(217592, 1790.693f, 1761.911f, 303.877f, (byte) 60, 6000); // S8_TestResult_55_Ah
			}
			case 217592 -> {
				setStage(StageType.START_STAGE_8_ROUND_5, 2000);
				sp(280790, npc.getX(), npc.getY(), npc.getZ(), npc.getHeading()); // BLF3_NM_PerfectManSum_45_Ae
				sp(217593, 1777.065f, 1763.706f, 303.695f, (byte) 90, 6000); // S8_TestResult_Boss_55_Ah
			}
			case 217593 -> {
				setStage(StageType.PASS_GROUP_STAGE_8, 0);
				sp(205342, 1776.757f, 1764.624f, 303.695f, (byte) 90); // IDArena_8th_MC_End
			}
			case 217594 -> {
				setStage(StageType.START_STAGE_9_ROUND_2, 2000);
				sp(217595, 1322.311f, 1741.508f, 316.349f, (byte) 65, 6000); // S9_Condor_Gi_55_Ah
			}
			case 217595 -> {
				setStage(StageType.START_STAGE_9_ROUND_3, 2000);
				sp(217596, 1308.038f, 1729.718f, 315.996f, (byte) 36, 6000); // S9_Manduri_Gi_55_Ah
				sp(217597, 1302.290f, 1745.471f, 316.092f, (byte) 96, 6000); // S9_Frillfaimam_Gi_55_Ah
			}
			case 217596, 217597 -> {
			...
			case 217609 -> {
				...
				sp(205344, 1764.6368f, 1288.831f, 394.23755f, (byte) 77); // IDArena_10th_MC_End
			}
		}
	}

	private void startBonusStage3() {
		sp(217742, 360.76f, 349.42f, 96.1f, (byte) 0); // S3_Elemeltal_Fire_55_Ah
		sp(217743, 346.27f, 363.35f, 96.1f, (byte) 11); // S3_Elemeltal_Wind_55_Ah
		sp(217740, 332.12f, 349.22f, 96.1f, (byte) 0); // S3_Elemeltal_Earth_55_Ah
		sp(217741, 346.42f, 335.1f, 96.1f, (byte) 87); // S3_Elemeltal_Warter_55_Ah
		ThreadPoolManager.getInstance().schedule(() -> {
			...
			ThreadPoolManager.getInstance().schedule(() -> {
				...
				ThreadPoolManager.getInstance().schedule(() -> {
					...
					ThreadPoolManager.getInstance().schedule(() -> {
						...
						sp(205331, 345.25f, 349.24f, 96.09097f, (byte) 0); // IDArena_4th_MC_Start
						sp(217735, 378.9331f, 346.74878f, 96.74762f, (byte) 0); // S3_ResurBox1_55_n
	...
	private void startBonusStage4() {
		sp(217778, 346.2f, 366.85f, 96.55f, (byte) 1); // S4_Draky_CTRL_Gate
		sp(217747, 346.2204f, 367.52002f, 96.090904f, (byte) 60, 3000); // S4_Draky_slow_55_An
		sp(217747, 346.2204f, 367.52002f, 96.090904f, (byte) 60, 6000); // S4_Draky_slow_55_An
		sp(217748, 346.65222f, 366.3634f, 96.09092f, (byte) 60, 9000); // S4_Draky_Epic_55_Ae
		sp(217748, 346.65222f, 366.3634f, 96.09092f, (byte) 60, 12000); // S4_Draky_Epic_55_Ae
		sp(217748, 345.7578f, 366.7986f, 96.09094f, (byte) 60, 15000); // S4_Draky_Epic_55_Ae
		sp(217748, 345.863f, 367.471f, 96.09094f, (byte) 60, 18000); // S4_Draky_Epic_55_Ae
		sp(217747, 346.9996f, 366.3978f, 96.09092f, (byte) 60, 21000); // S4_Draky_slow_55_An
		sp(217746, 345.7872f, 366.3056f, 96.09092f, (byte) 60, 24000); // S4_Draky_Mid_55_An
		sp(217745, 346.4504f, 367.8004f, 96.09094f, (byte) 60, 27000); // S4_Draky_Fast_55_An
		sp(217747, 346.75043f, 367.467f, 96.09094f, (byte) 60, 30000); // S4_Draky_slow_55_An
		sp(217747, 346.535f, 367.3128f, 96.090904f, (byte) 60, 33000); // S4_Draky_slow_55_An
		sp(217747, 345.8452f, 367.2468f, 96.09092f, (byte) 60, 36000); // S4_Draky_slow_55_An
		sp(217746, 345.428f, 366.2954f, 96.09093f, (byte) 60, 39000); // S4_Draky_Mid_55_An
		sp(217747, 346.71082f, 366.7156f, 96.090904f, (byte) 60, 42000); // S4_Draky_slow_55_An
		sp(217747, 346.38782f, 366.1606f, 96.09093f, (byte) 60, 45000); // S4_Draky_slow_55_An
		sp(217747, 345.36002f, 366.0284f, 96.09093f, (byte) 60, 48000); // S4_Draky_slow_55_An
		sp(217747, 345.5378f, 366.1876f, 96.09092f, (byte) 60, 51000); // S4_Draky_slow_55_An
		sp(217747, 346.5176f, 365.8592f, 96.09092f, (byte) 60, 54000); // S4_Draky_slow_55_An
		sp(217745, 345.8434f, 367.8082f, 96.090904f, (byte) 60, 57000); // S4_Draky_Fast_55_An
		sp(217747, 345.297f, 366.3014f, 96.09093f, (byte) 60, 60000); // S4_Draky_slow_55_An
		sp(217747, 346.0346f, 367.2426f, 96.090904f, (byte) 60, 63000); // S4_Draky_slow_55_An
		sp(217747, 345.52863f, 366.62622f, 96.09092f, (byte) 60, 66000); // S4_Draky_slow_55_An
		sp(217745, 345.80862f, 366.9388f, 96.09092f, (byte) 60, 69000); // S4_Draky_Fast_55_An
		sp(217747, 346.393f, 366.9766f, 96.090904f, (byte) 60, 72000); // S4_Draky_slow_55_An
		sp(217746, 345.5726f, 366.3462f, 96.09092f, (byte) 60, 75000); // S4_Draky_Mid_55_An
		sp(217745, 345.2004f, 366.36902f, 96.09092f, (byte) 60, 78000); // S4_Draky_Fast_55_An
		sp(217746, 346.2528f, 365.9208f, 96.09093f, (byte) 60, 81000); // S4_Draky_Mid_55_An
		sp(217747, 346.0686f, 366.9096f, 96.090904f, (byte) 60, 84000); // S4_Draky_slow_55_An
		sp(217746, 345.4606f, 367.14862f, 96.090904f, (byte) 60, 87000); // S4_Draky_Mid_55_An
		sp(217747, 345.8016f, 367.7212f, 96.090904f, (byte) 60, 90000); // S4_Draky_slow_55_An
	...
	private void startStage4Round4_1() {
		List<Npc> round = new ArrayList<>();
		round.add(sp(217508, 334.06754f, 339.84393f, 96.09091f, (byte) 0)); // S2_LycanFighter_55_Ae
		empyreanStage.add(new EmpyreanStage(round));
		ThreadPoolManager.getInstance().schedule(() -> {
			List<Npc> round1 = new ArrayList<>();
			round1.add(sp(217506, 342.12405f, 364.4922f, 96.09093f, (byte) 0)); // S2_LycanPriest_55_Ae
			round1.add(sp(217507, 344.4953f, 365.14444f, 96.09092f, (byte) 0)); // S2_LycanRanger_55_Ae
	...
	private void startStage4Round3() {
		...
		sp(217563, 339.70975f, 333.54272f, 96.090904f, (byte) 20, 6000); // S5_Drakan_Fi_55_Ae
		sp(217564, 342.92892f, 333.43994f, 96.09092f, (byte) 18, 6000); // S5_Drakan_As_55_Ae
		sp(217565, 341.55396f, 330.70847f, 96.09093f, (byte) 23, 12000); // S5_Drakan_Wi_55_Ae
		ThreadPoolManager.getInstance().schedule(() -> {
			List<Npc> round = new ArrayList<>();
			round.add(sp(217566, 362.87164f, 357.87164f, 96.091125f, (byte) 73)); // S5_Drakan_Pr_55_Ae
			round.add(sp(217563, 359.1135f, 359.6953f, 96.091125f, (byte) 80)); // S5_Drakan_Fi_55_Ae
			empyreanStage.add(new EmpyreanStage(round));
		}, 43000);
	}
	...
	private void startStage2Round2() {
		...
		sp(217502, 328.78433f, 348.77353f, 96.09092f, (byte) 0, 6000); // S2_RatmanWarrior_55_Ae
		sp(217508, 329.01874f, 343.79257f, 96.09092f, (byte) 0, 6000); // S2_LycanFighter_55_Ae
		sp(217507, 329.2849f, 355.2314f, 96.090935f, (byte) 0, 6000); // S2_LycanRanger_55_Ae
		sp(217504, 328.90808f, 351.6184f, 96.09092f, (byte) 0, 6000); // S2_RatmanScout_55_Ae
	}
	...
	public void onChangeStage(StageType type) {
		switch (type) {
			...
			case START_STAGE_2_ELEVATOR -> {
				...
				sp(217503, 325.71194f, 352.81027f, 96.09092f, (byte) 0, 9000); // S2_RatmanGatherer_55_Ae
				sp(217502, 325.78696f, 346.07263f, 96.090904f, (byte) 0, 9000); // S2_RatmanWarrior_55_Ae
				sp(217504, 325.06122f, 349.4784f, 96.090904f, (byte) 0, 9000); // S2_RatmanScout_55_Ae
			}
			case START_STAGE_3_ELEVATOR -> {
				setStage(type, 0);
				setStage(StageType.START_STAGE_3_ROUND_1, 5000);
				stage = 3;
				sp(217512, 344.23056f, 347.89594f, 96.09096f, (byte) 0, 9000); // S3_ElementalFire_1st_55_Ae
				sp(217513, 341.09082f, 337.95187f, 96.09097f, (byte) 0, 9000); // S3_ElementalWater_1st_55_Ae
				sp(217512, 342.06656f, 361.16135f, 96.090935f, (byte) 0, 9000); // S3_ElementalFire_1st_55_Ae
				sp(217511, 356.75006f, 335.27487f, 96.09096f, (byte) 0, 9000); // S3_ElementalEarth_1st_55_Ae
				sp(217514, 345.4355f, 365.05215f, 96.09093f, (byte) 0, 9000); // S3_ElementalAir_1st_55_Ae
				sp(217512, 352.8222f, 358.33463f, 96.09092f, (byte) 0, 9000); // S3_ElementalFire_1st_55_Ae
				sp(217513, 342.32755f, 365.00473f, 96.09093f, (byte) 0, 9000); // S3_ElementalWater_1st_55_Ae
				sp(217514, 356.19113f, 362.22543f, 96.090965f, (byte) 0, 9000); // S3_ElementalAir_1st_55_Ae
				sp(217511, 344.25127f, 334.1194f, 96.090935f, (byte) 0, 9000); // S3_ElementalEarth_1st_55_Ae
				sp(217511, 344.07086f, 346.8839f, 96.09092f, (byte) 0, 9000); // S3_ElementalEarth_1st_55_Ae
				sp(217514, 334.01746f, 350.76382f, 96.090935f, (byte) 0, 9000); // S3_ElementalAir_1st_55_Ae
				sp(217513, 344.49155f, 351.73932f, 96.09093f, (byte) 0, 9000); // S3_ElementalWater_1st_55_Ae
				sp(217513, 353.0832f, 362.178f, 96.09092f, (byte) 0, 9000); // S3_ElementalWater_1st_55_Ae
				sp(217511, 356.24454f, 358.34552f, 96.09103f, (byte) 0, 9000); // S3_ElementalEarth_1st_55_Ae
				sp(217512, 330.64853f, 346.87302f, 96.09091f, (byte) 0, 9000); // S3_ElementalFire_1st_55_Ae
				sp(217512, 353.32773f, 335.26398f, 96.09092f, (byte) 0, 9000); // S3_ElementalFire_1st_55_Ae
				sp(217514, 356.69666f, 339.1548f, 96.09103f, (byte) 0, 9000); // S3_ElementalAir_1st_55_Ae
				sp(217511, 347.6529f, 347.90683f, 96.09098f, (byte) 0, 9000); // S3_ElementalEarth_1st_55_Ae
				sp(217514, 347.5995f, 351.78674f, 96.09099f, (byte) 0, 9000); // S3_ElementalAir_1st_55_Ae
				sp(217512, 340.82983f, 334.1085f, 96.09093f, (byte) 0, 9000); // S3_ElementalFire_1st_55_Ae
				sp(217514, 344.19876f, 337.9993f, 96.09094f, (byte) 0, 9000); // S3_ElementalAir_1st_55_Ae
				sp(217513, 353.5887f, 339.10763f, 96.09092f, (byte) 0, 9000); // S3_ElementalWater_1st_55_Ae
				sp(217511, 345.4889f, 361.17224f, 96.090935f, (byte) 0, 9000); // S3_ElementalEarth_1st_55_Ae
				sp(217513, 330.90952f, 350.7164f, 96.09093f, (byte) 0, 9000); // S3_ElementalWater_1st_55_Ae
			}
			case START_STAGE_4_ELEVATOR -> {
				...
				stage = 4;
				sp(217557, 328.88104f, 349.55392f, 96.090904f, (byte) 0, 9000); // S5_Lizard_Fi_55_Ae
				sp(217559, 328.38922f, 342.39066f, 96.09091f, (byte) 5, 9000); // S5_Lizard_Pr_55_Ae
				sp(217557, 333.17947f, 336.4504f, 96.090904f, (byte) 8, 9000); // S5_Lizard_Fi_55_Ae
			}
			case START_STAGE_5_ROUND_1 -> {
				setStage(type, 2000);
				sp(217549, 1263.1987f, 778.4129f, 358.6056f, (byte) 30, 6000); // S4_ShulackWi_55_Ae
				sp(217548, 1260.1381f, 778.84644f, 358.60562f, (byte) 30, 6000); // S4_ShulackRa_55_Ae
				sp(217547, 1257.3065f, 778.35016f, 358.60562f, (byte) 30, 6000); // S4_ShulackAs_55_Ae
			}
			...
			case START_STAGE_9_ROUND_1 -> {
				setStage(type, 2000);
				sp(217594, 1274.890f, 1730.676f, 318.194f, (byte) 3, 6000); // S9_Potcrab_Gi_55_Ah
			}
			...
			case START_STAGE_5 -> {
				stage = 5;
				sp(205426, 1256.2872f, 834.28986f, 358.60565f, (byte) 103); // IDArena_5th_Resurrect_NPC
				sp(205332, 1260.1292f, 795.06964f, 358.60562f, (byte) 30); // IDArena_5th_MC_Start
				teleport(1260.15f, 812.34f, 358.6056f, (byte) 90);
				setStage(type, 1000);
			}
			case START_STAGE_6 -> {
				stage = 6;
				sp(205427, 1594.4756f, 145.26898f, 128.67778f, (byte) 16); // IDArena_6th_Resurrect_NPC
				sp(205333, 1625.1771f, 159.15244f, 126f, (byte) 70); // IDArena_6th_MC_Start
				teleport(1616.0248f, 154.43837f, 126f, (byte) 10);
				setStage(type, 1000);
			}
			case START_STAGE_7 -> {
				stage = 7;
				sp(205428, 1820.39f, 800.81805f, 470.1394f, (byte) 86); // IDArena_7th_Resurrect_NPC
				sp(205334, 1781.6106f, 796.9224f, 469.35016f, (byte) 0); // IDArena_7th_MC_Start
			...
			case START_STAGE_9 -> {
				stage = 9;
				sp(205430, 1359.375f, 1758.057f, 319.625f, (byte) 90); // IDArena_9th_Resurrect_NPC
				sp(205336, 1309.309f, 1732.540f, 315.782f, (byte) 7); // IDArena_9th_MC_Start
				teleport(1320.4513f, 1738.4838f, 316.1746f, (byte) 66);
				setStage(type, 1000);
			}
			case START_STAGE_10 -> {
				stage = 10;
				sp(205431, 1755.709f, 1253.4136f, 394.2378f, (byte) 33); // IDArena_10th_Resurrect_NPC
				sp(205337, 1766.5986f, 1291.2572f, 394.23755f, (byte) 82, 10000); // IDArena_10th_MC_Start
